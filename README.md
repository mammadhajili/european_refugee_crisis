...
We conduct a study on politic approach, news media coverage and people's oponion by searching the key words or sentiment analysis related to refugee crisis from January 1st 2015 to December 31st 2017 based on Global Database of Events, Language, and Tone (GDELT), Twitter database, wikipedia etc.
